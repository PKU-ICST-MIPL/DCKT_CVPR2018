function mapI_TI = QryonTestBi_Train( W, testImgCat, testTxtCat )
...
[mapI_TI,mapICategory] = evaluateMAP_fast_general_Train(ImgQuery,testImgCat,testTxtCat,catImgNum);

%draw the pr curve
%[mapI,prIQ,catMAPIQ] = evaluateMAPBi(ImgQuery,testImgCat, testTxtCat);
%APTQ] = evaluateMAPBi(TxtQuery,testTxtCat, testImgCat);
end
